...
public class MainController {
    ...
    public ResponseEntity<?> persist(@Valid @RequestBody UserDTO dto){
        ...
        if(user.isEmpty()){
            return new ResponseEntity<>(ResultResponse.builder().status(true).message(HttpMessageResponse.SAVE_SUCESS.getValue()).data(userService.persist(dto)).build(), HttpStatus.OK);
        }else{
